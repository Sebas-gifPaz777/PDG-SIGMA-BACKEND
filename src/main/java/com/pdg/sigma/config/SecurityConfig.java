...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://pdg-sigma.vercel.app/")); // origen del frontend
        configuration.setAllowedOrigins(List.of("http://200.3.193.229:3000")); // origen del frontend
